<div class="side">
    ...
    <section class="block">
        ...
        <div class="animated list category">
            <?php $this->widget('Widget_Metas_Category_List')->parse('<div class="item"><a href="{permalink}" target="_parent">{name}</a> <div class="ui label">{count}</div></div>'); ?>
        </div>
    </section>
    <?php endif; ?>
